...
modern-arecibo --output "images/original.png"

# original image with the genome and population highlighted
modern-arecibo --output "images/highlight.png" --highlight-population --highlight-genome

# modern image
modern-arecibo --output "images/modern.png" --population $population_2025 --genome $t2t

# modern image without Pluto
modern-arecibo --output "images/modern-no-pluto.png" --population $population_2025 --genome $t2t --pluto-is-not-a-planet

# image with the maximum possible population (assuming six rows maximum) highlighted
modern-arecibo --output "images/maxpop-six-rows.png" --highlight-population --population $max_pop_six_rows --genome $t2t
...
modern-arecibo --output "images/maxpop.png" --highlight-population --population $max_pop --genome $t2t

# image with the maximum possible population highlighted, if we eliminate the planets past Jupiter.
modern-arecibo --output "images/supermaxpop.png" --highlight-population --population $super_max_pop --genome $t2t
